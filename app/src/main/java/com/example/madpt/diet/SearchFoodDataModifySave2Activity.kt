...
import com.example.madpt.databinding.ActivitySearchFoodDataModifySave2Binding
import org.w3c.dom.Text
import java.lang.Math.round
import java.lang.NumberFormatException


class SearchFoodDataModifySave2Activity : AppCompatActivity() {
    private lateinit var binding: ActivitySearchFoodDataModifySave2Binding


    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivitySearchFoodDataModifySave2Binding.inflate(layoutInflater)
